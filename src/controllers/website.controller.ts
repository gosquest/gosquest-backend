...
export const createWebsite = async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        return res.status(201).json({ success: true, message: "Website created successfully", savedWebsite });
...
export const getWebsiteById = async (req: Request, res: Response): Promise<any> => {
    try {
...
// Get all websites
export const getAllWebsites = async (_req: Request, res: Response): Promise<any> => {
    try {
...
export const updateWebsite = async (req: Request, res: Response): Promise<any> => {
    try {
        const { websiteId } = req.params;
